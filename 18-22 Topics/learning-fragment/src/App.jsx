...
/*
  --> In React, the useState hook 'returns' an array with two elements:
      The current state value: This represents the current state of the component.
      A function to update the state: This function allows you to change the state value.
*/
function App() {
