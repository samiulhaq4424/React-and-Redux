// sidebar is taken from bootstrap: https://getbootstrap.com/docs/5.3/examples/sidebars/
const Sidebar = ({ selectedTab, setSelectedTab }) => {
  return (
    <div
      className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark mySidebar"
      style={{ width: "180px" }}> {/* width is set to 180px*/}
      <a
        href="/"
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        ...
        >
          <a
            href="#"
            className={`nav-link text-white ${(selectedTab === "Home") && "active"}`} //${selectedTab === "Home" && "active"} added for active hone ke liye i.e blue color
            aria-current="page"
          >
        ...
        >
          <a
            href="#"
            className={`nav-link text-white ${(selectedTab === "Create Post") && "active"}`}//{(selectedTab === "Create Post") && "active"} added for active hone ke liye i.e blue
          >
            <svg className="bi pe-none me-2" width="16" height="16">
